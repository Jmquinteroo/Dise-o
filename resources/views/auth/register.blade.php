...
<div class="container">
    <div class="row justify-content-center">
        <label class="text-right">Por favor ingrese la siguiente información</label>
        <div class="col-md-10">
{{--            <div class="card">--}}
...
{{--                <div class="card-body">--}}
                    <form method="post" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="number" pattern="/^[9|6|2|3][0-9]{7}$/" min="1000000" step="1" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{ old('telefono') }}" required autocomplete="telefono" autofocus>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right">{{ __('Confirmación contraseña') }}</label>
